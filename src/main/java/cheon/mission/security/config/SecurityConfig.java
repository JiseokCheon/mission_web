package cheon.mission.security.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/", "/css/**", "/images/**", "/js/**", "/assets/**", "/error/**", "/login_page/**", "/charts").permitAll()
                .antMatchers("/register/**","/mission/**", "/posting/**").hasRole(Role.USER.name())
